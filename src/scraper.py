...
def scrape_article(link: str) -> str:
    ...
    title: str = soup.find('h1', attrs={'class':'story__title'}).text
    summary: str = soup.find('div', attrs={'class':'story__summary'}).text
    content: str = soup.find('div', attrs={'class':'story__text'}).text
